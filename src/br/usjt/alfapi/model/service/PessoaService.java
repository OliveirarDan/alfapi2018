...
public class PessoaService {
	...
	/**
	 * InserirPessoa - Esse método insere a pessoa no azure, recebe o codAzure e insere os dados da pessoa no banco. 
	...
	/**
	 * inserirFotoPessoa - Esse método recebe 1 foto (endereço em string) e envia para o azure
	 * @param pessoa 
	 * @param foto - Endereço da foto
	 * @throws IOException
	 */
	...
	/**
	 * treinarAPI - Esse método faz a API da azure treinar.
	 * Reconhece as fotos já carregadas e aumenta a precisão da identificação.
	 */
	...
	/**
	 * identificarPessoa - Esse método recebe o endereço de uma foto.
	 ...
	 * @param urlFoto - Foto selecionada para fazer a identificação.
	 */
